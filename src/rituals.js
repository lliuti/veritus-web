export const ritualsJSON = [
    ...
    },
    {
        ...
        resistance: 'Fortitude reduz à metade',
        description: 'Você manifesta em suas mãos uma pequena cópia do alvo feita de cinzas. No início de cada um de seus turnos, você pode gastar uma ação padrão para se manter concentrado ou uma ação livre para descarregar o efeito. Se descarregar, a cópia explode e o alvo sofre dano de Morte igual a quantidade de dano que sofreu desde que o ritual foi conjurado (Fortitude reduz à metade). Se você não descarregar até a segunda rodada após conjurá-lo, ele é dissipado.',
        ascended: '(+3 PE): muda a duração para “até 3 rodadas”. Se você não descarregar até a terceira rodada após conjurá-lo, ele é dissipado.',
        awoken: '(+7 PE): muda a ação necessária para se concentrar para movimento e o alvo para até 5 seres. Requer 4º círculo e afinidade.',
    ...
    },
    {
        ...
        duration: '3 rodadas',
        resistance: 'Fortitude parcial',
        description: 'Você cria um vácuo em um espaço desocupado a sua escolha, capaz de sugar tudo nas proximidades. No início de cada um de seus três turnos seguintes, todos os seres a até 90m do vácuo, incluindo você, devem fazer um teste de Fortitude. Em caso de falha, ficam caídas e são puxadas 30m na direção do vácuo. Objetos soltos também são puxados. Seres podem gastar uma ação de movimento para se segurar em algum objeto fixo, recebendo +5 em seus testes de resistência. Seres e objetos que toquem o vácuo temporal são desintegrados, desaparecendo para sempre.',
        ascended: '(+5 PE): muda a duração para “4 rodadas” e o efeito para que você não seja afetado. Requer afinidade.',
        awoken: '(+10 PE): muda a duração para “5 rodadas” e o efeito para que seres escolhidos dentro do alcance não sejam afetados. Requer afinidade.',
